...
export default function Hero() {
  ...
  return (
    <section id="hero" className="min-h-screen grid grid-cols-1 md:grid-cols-2 pt-20 overflow-hidden">
      {/* LEFT */}
      <div className="bg-cream flex flex-col justify-center px-8 md:px-12 lg:px-16 py-20 overflow-hidden">
            <motion.p
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                transition={{ delay: 1.1, duration: 0.6 }}
                className="text-xs tracking-[0.18em] text-mid-gray uppercase mb-8 leading-relaxed"
            >
                {info.tagline}
            </motion.p>
            ...
            >
                <a
                    href="#projects"
                    className="bg-off-black text-white text-sm px-7 py-3 rounded-sm hover:opacity-75 transition-opacity duration-200"
                >
                    View Projects
                </a>
                <a
