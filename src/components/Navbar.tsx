...
export default function Navbar() {
    ...
    return (
        <>
            ...
            >
                <span className="font-serif font-bold text-[1.05rem] tracking-tight text-off-black">
                    {info.name}
                </span>
                ...
                <div className="flex items-center gap-4">
                    ...
                    <a
                        ...
                        className="hidden md:block bg-off-black text-white text-xs tracking-widest px-5 py-2 rounded-sm hover:opacity-75 transition-opacity duration-200"
                    >
                        Download CV
                    </a>
            ...
            <AnimatePresence>
                {menuOpen && (
                    <motion.div
                        ...
                        className="fixed top-[72px] left-0 right-0 z-40 bg-white border-b border-border-light md:hidden"
                    >
